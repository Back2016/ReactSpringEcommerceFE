        ...
        const fetchOrder = async () => {
            try {
                await withValidToken(async (token) => {
                    ...
                    // Only fetch user info if the order has a user attached
                    if (found.userId !== null && found.userId !== undefined) {
                        try {
                            ...
                            {userInfo ? (
                                ...
                                <div className="border-t pt-4 space-y-1 text-sm">
                                    ...
                                    {order.shippingAddress?.recipientName && (
                                        <p><span className="text-muted-foreground">Recipient:</span> {order.shippingAddress.recipientName}</p>
                                    )}
                                </div>
                            )}
                        </CardContent>
